...
import net.opengis.sensorML.x101.DocumentListDocument.DocumentList.Member;
  ...
  // ---------------------------------------------------------------------------
	...
	private void createDocumentation() {
		...
		for (DocumentMember documentMember : station.getDocumentation()) {
		    Member xbMember = xbDocumentList.addNewMember();
	...
	private void createContactOperator(){
	    if (station.getSource() != null) {
    	    ...
    	    xbContact.setRole("http://mmisw.org/ont/ioos/definition/operator");
