...
into an [https://code.google.com/p/ioostech/](IOOS customized) [http://52north.org/communities/sensorweb/sos/](52&deg;North SOS).

Applications using this toolkit should provide implementations of StationRetriever and ObservationRetriever that properly construct
data objects (SosStation, SosSensor, ObservationCollection, etc) for the targeted sensor provider. Alternatively, ObservationCollections
can be constructed and inserted manually.
